...
% * Shear force diagram
% * Bending Moment daigramSimply Supported Beam
```
...
Length of beam in meter = 21
 
Type 1 for point load, Type 2 for udl
Load case = 2
 
Uniformly distributed load in kN/m = 18
 
Length of udl in meter = 7
 
C.G of udl from left end of the beam in meter = 3
 
Left support Reaction = 108 kN
 
Left support Reaction = 18 kN
 
Maximum bending moment = 270 kNm
>> 
...
A cummulative pointer to SF x BM
![](fd11_results.jpg)


### Reference:

Download the [`fd11.m`](fd11.m) to your device.
